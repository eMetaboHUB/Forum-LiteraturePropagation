...
for alpha in alpha_set:
    ...
    for sample_size in sample_size_set:
        ...
        # If only a mesh has been provided
            ...
            df_ = pd.DataFrame({"SPECIE": args.specie, "MESH": args.mesh, "Mean": [res.Mean], "CDF": [res.CDF], "Log2FC": [res.Log2FC], "priorCDFratio": [res.priorCDFratio], "priorLog2FC": [res.priorLog2FC], "Score": [res.Score], "NeighborhoodInformation": [res.NeighborhoodInformation]})
