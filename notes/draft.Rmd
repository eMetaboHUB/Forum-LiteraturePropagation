...
Ainsi, $\forall i \in CTB_k, i \neq k: \frac{\pi_{k,i}}{(1 - \pi_{i,i})} > \frac{1}{n -1}$. Vue que l'on empêche les composés de contribuer à eux-même, le composé $k$ ne peut pas faire partie de son voisinnage d'influence donc il ne contribue toujours pas au prior !
...
$p(c_i|I = k) = \frac{P(I=k|c_k)p(c_k)}{\sum_j P(I=k|c_j)p(c_j)} = 0$ car $P(I = k|c_k) = 0$ 

- Pour $i \in CTB_k$:

$p(c_i|I = k) = \frac{P(I=k|c_i)p(c_i)}{\sum_j P(I=k|c_j)p(c_j)} = \frac{\frac{\pi_{k,i} }{\sum_{v \in IN_i} \pi_{v,i}} \frac{N_i}{N} }{\sum_j \frac{\pi_{k,j} }{\sum_{v \in IN_j} \pi_{v,j}} \frac{N_j}{N} } = \frac{\frac{\pi_{k,i}}{\sum_{v \in IN_i} \pi_{v,i}} N_i}{\sum_j \frac{\pi_{k,j} }{\sum_{v \in IN_j} \pi_{v,j}} N_j}$
