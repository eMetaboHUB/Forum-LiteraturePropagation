...
if args.file:
    ...
    except pd.io.parsers.ParserError as except_parsing_error:
        print(args.file + " has incorrect format.\n" + str(except_parsing_error))
        sys.exit(1)

    except FileNotFoundError as excep_f_not_found:
        print("File not found at " + args.file + "\n" + str(excep_f_not_found))
        sys.exit(1)
